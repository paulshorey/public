...
$(document).ready(function () {
  ...
  $("[secret-tel]").each(function () {
    $(this).get(0).innerHTML =
      $(this).attr("secret-tel1") +
      "." +
      $(this).attr("secret-tel2") +
      "." +
      $(this).attr("secret-tel3");
    $(this).attr(
      "href",
      "tel:" +
        $(this).attr("secret-tel1") +
...
function isVideoInView(video) {
  var middle =
    (window.innerHeight || document.documentElement.clientHeight) * (2 / 5);
  var rect = video.getBoundingClientRect();
  if (rect.top < middle && rect.top + video.clientHeight >= middle) {
    return true;
  }
}
$(document).ready(function () {
